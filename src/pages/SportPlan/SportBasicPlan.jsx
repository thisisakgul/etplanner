...
const programs = {
  'Kilo Kaybı': {
    Pazartesi:   [
      ...
      { name: 'Jump Rope',          sets: 4, reps: 60 }, // saniye
  ...
  'Kas Kazanımı': {
    ...
    Cumartesi:    [
      ...
      { name: 'Farmer’s Walk',      sets: 3, reps: 30, unit: 'sn' },
    ],
    Pazar:        [
      { name: 'Rest Day',           sets: 0, reps: 0 },
...
export default function SportBasicPlan() {
  ...
  return (
    <div className="max-w-screen-md mx-auto p-6">
      {!goal ? (
        <>
          <h2 className="text-2xl font-bold mb-4 text-center">Basic Plan Hedef Seçimi</h2>
